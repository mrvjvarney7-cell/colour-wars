...
def main():
    ...
    for iteration in range(args.iterations):
        ...
        candidate_path = os.path.join(CHECKPOINT_DIR, f"iter_{iteration + 1}.pt")
        ...
        if promoted:
            ...
            print("Candidate did not beat previous best by enough margin -> keeping previous best, "
                  "but continuing training from candidate weights.")
